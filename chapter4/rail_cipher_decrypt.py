...
import itertools # using zip_longest() function for decryption
...
def main():
    """Run program to decrypt 2-rail rail cipher."""
...
def split_rails(message):
    """Split message in two, always rounding UP the first fow"""
...
def decrypt(row1, row2):
    ...
    # using itertools b/c python prevents looping through uneven sequences by raising an index out of range error
        plaintext.append(r1)
        plaintext.append(r2)
